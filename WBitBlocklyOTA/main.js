...
// let tray = new nw.Tray({ title: 'Tray', icon: 'util/app.png' });
// let menu = new nw.Menu();
// let menuItem1 = new nw.MenuItem({ label: 'Menu Item 1' });
// menuItem1.click = function() { console.log('Menu Item 1 clicked'); };
// menu.append(menuItem1);
// let menuItem2 = new nw.MenuItem({ label: '離開 WBit USB Adapter' });
// menuItem2.click = function() { process.exit(); };
